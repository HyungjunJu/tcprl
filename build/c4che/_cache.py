...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/hj/anaconda3/envs/tcprl/include', '-fdebug-prefix-map=/tmp/build/80754af9/python_1599604603603/work=/usr/local/src/conda/python-3.6.12', '-fdebug-prefix-map=/home/hj/anaconda3/envs/tcprl=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/hj/anaconda3/envs/tcprl/include', '-fdebug-prefix-map=/tmp/build/80754af9/python_1599604603603/work=/usr/local/src/conda/python-3.6.12', '-fdebug-prefix-map=/home/hj/anaconda3/envs/tcprl=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
...
ENABLE_ZMQ = True
EXAMPLE_DIRECTORIES = ['udp-client-server', 'routing', 'stats', 'ipv6', 'realtime', 'naming', 'matrix-topology', 'tutorial', 'energy', 'wireless', 'error-model', 'udp', 'socket', 'tcp', 'traffic-control']
...
INCLUDES_PYEMBED = ['/home/hj/anaconda3/envs/tcprl/include/python3.6m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIB = ['zmq', 'protobuf']
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/home/hj/anaconda3/envs/tcprl/lib/python3.6/config-3.6m-x86_64-linux-gnu', '/home/hj/anaconda3/envs/tcprl/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
NS3_EXECUTABLE_PATH = ['/home/hj/PycharmProjects/tcprl/build/src/fd-net-device', '/home/hj/PycharmProjects/tcprl/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/9', '/home/hj/PycharmProjects/tcprl/build/lib']
...
PYO = 1
PYTAG = 'cpython-36'
PYTHON = ['/home/hj/anaconda3/envs/tcprl/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python3.6/site-packages'
PYTHONDIR = '/usr/local/lib/python3.6/site-packages'
PYTHON_CONFIG = ['/home/hj/anaconda3/envs/tcprl/bin/python3.6-config']
PYTHON_VERSION = '3.6'
...
cfg_files = ['/home/hj/PycharmProjects/tcprl/build/ns3/config-store-config.h', '/home/hj/PycharmProjects/tcprl/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_NET_ETHERNET_H', 'HAVE_IF_TUN_H', 'HAVE_PACKET_H', 'HAVE_ZMQ', 'HAVE_PROTOBUF']
