...
for e in range(total_episodes):
    ...
    for time in range(max_env_steps):
        ...
        action_history.append(action_mapping[action_index])
        ...
        cWnd = next_state[5]
        print("cWnd:", cWnd)
        print(next_state[9], next_state[10])
        if done:
    ...
    if e % 2 == 0:
        ...
        plt.subplot(313)
        plt.plot(range(len(action_history)), action_history, label='Action', marker="", linestyle='-')
